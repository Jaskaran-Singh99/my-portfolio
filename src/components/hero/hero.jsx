    ...
    <motion.div className="hero" >
       ...
       <motion.div className="textContainer" variants={variants} initial="initial" animate="animate" >
            ...
            <motion.div className="buttons" variants={variants}>
                <motion.button className='button'><a href='#Projects'>Projects</a></motion.button>
                <motion.button className='button'><a href="./jaskaran_resume.pdf">Download Resume</a></motion.button>
